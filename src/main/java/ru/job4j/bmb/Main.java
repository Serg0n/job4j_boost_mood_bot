...
public class Main {
    ...
    CommandLineRunner loadDatabase(MoodRepository moodRepository,
        ...
        return args -> {
            ...
            awards.add(new Award("Настроение недели", "За 7 последовательных дней хорошего настроения.", 7));
            ...
            awards.add(new Award("Достижение 'Солнечный луч'", "За 10 дней подряд с хорошим настроением.", 10));
            awards.add(new Award("Виртуальный подарок", "После 15 дней хорошего настроения.", 15));
            awards.add(new Award("Титул 'Лучезарный'", "За 20 дней хорошего настроения.", 20));
            awards.add(new Award("Доступ к премиум-функциям", "После 30 дней хорошего настроения.", 30));
            awards.add(new Award("Участие в розыгрыше", "За каждую неделю хорошего настроения.", 7));
            awards.add(new Award("Эксклюзивный контент", "После 25 дней хорошего настроения.", 25));
            awards.add(new Award("Награда 'Настроение месяца'", "За месяц хорошего настроения.", 30));
            ...
            awards.add(new Award("Персональное поздравление", "За 50 дней хорошего настроения.", 50));
